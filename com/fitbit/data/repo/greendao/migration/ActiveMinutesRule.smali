.class final Lcom/fitbit/data/repo/greendao/migration/ActiveMinutesRule;
.super Lcom/fitbit/data/repo/greendao/migration/MigrationRule;
.source "SourceFile"


# static fields
.field private static final ACTIVE_MINUTES_TRACKER_SETTING_SINCE_VERSION:I = 0x75

.field private static final TAG:Ljava/lang/String; = "ActiveMinutesRule"
...
.method protected executeRuleForDao(Landroid/database/sqlite/SQLiteDatabase;Lcom/fitbit/data/repo/greendao/migration/MigrationDaoResult;)Lcom/fitbit/data/repo/greendao/migration/MigrationResult;
    ...
    .line 38
    :cond_f
    sget-object v0, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao$Properties;->DisplayActiveMinutes:Lde/greenrobot/dao/Property;
    ...
    :try_end_22
    .catch Ljava/lang/Throwable; {:try_start_1d .. :try_end_22} :catch_35
    ...
    .line 43
    const-string v2, "ActiveMinutesRule"
