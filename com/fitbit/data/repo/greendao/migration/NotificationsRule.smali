.class final Lcom/fitbit/data/repo/greendao/migration/NotificationsRule;
.super Lcom/fitbit/data/repo/greendao/migration/MigrationRule;
.source "SourceFile"


# static fields
.field private static final NOTIFICATIONS_SINCE_VERSION:I = 0x6e

.field private static final TAG:Ljava/lang/String; = "NotificationsRule"
...
.method protected executeRuleForDao(Landroid/database/sqlite/SQLiteDatabase;Lcom/fitbit/data/repo/greendao/migration/MigrationDaoResult;)Lcom/fitbit/data/repo/greendao/migration/MigrationResult;
    ...
    const-class v1, Lcom/fitbit/data/repo/greendao/NotificationDao;
    ...
    .line 38
    :cond_f
    const-string v0, "NotificationsRule"
    ...
    .line 39
    invoke-static {p1, v3}, Lcom/fitbit/data/repo/greendao/NotificationDao;->dropTable(Landroid/database/sqlite/SQLiteDatabase;Z)V

    .line 40
    invoke-static {p1, v3}, Lcom/fitbit/data/repo/greendao/NotificationDao;->createTable(Landroid/database/sqlite/SQLiteDatabase;Z)V
    ...
    const-class v2, Lcom/fitbit/data/repo/greendao/NotificationDao;
