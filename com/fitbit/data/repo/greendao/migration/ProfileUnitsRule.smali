.class final Lcom/fitbit/data/repo/greendao/migration/ProfileUnitsRule;
.super Lcom/fitbit/data/repo/greendao/migration/MigrationRule;
.source "SourceFile"


# static fields
.field private static final PROFILE_UNITS_COLUMN_SINCE_VERSION:I = 0x67

.field private static final TAG:Ljava/lang/String; = "ProfileUnitsRule"
...
.method protected executeRuleForDao(Landroid/database/sqlite/SQLiteDatabase;Lcom/fitbit/data/repo/greendao/migration/MigrationDaoResult;)Lcom/fitbit/data/repo/greendao/migration/MigrationResult;
    ...
    .line 38
    :cond_f
    sget-object v0, Lcom/fitbit/data/repo/greendao/ProfileDao$Properties;->HeightUnit:Lde/greenrobot/dao/Property;
    ...
    .line 39
    sget-object v1, Lcom/fitbit/data/repo/greendao/ProfileDao$Properties;->WeightUnit:Lde/greenrobot/dao/Property;
    ...
    .line 40
    sget-object v2, Lcom/fitbit/data/repo/greendao/ProfileDao$Properties;->WaterUnit:Lde/greenrobot/dao/Property;
    ...
    .line 43
    :try_start_2d
    invoke-static {p1, v0, v3}, Lcom/fitbit/data/repo/greendao/migration/MigrationUtils;->addEmptyTextColumn(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)V

    .line 44
    invoke-static {p1, v1, v3}, Lcom/fitbit/data/repo/greendao/migration/MigrationUtils;->addEmptyTextColumn(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)V

    .line 45
    invoke-static {p1, v2, v3}, Lcom/fitbit/data/repo/greendao/migration/MigrationUtils;->addEmptyTextColumn(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_36
    .catch Ljava/lang/Throwable; {:try_start_2d .. :try_end_36} :catch_4a
    ...
    .line 47
    const-string v1, "ProfileUnitsRule"
