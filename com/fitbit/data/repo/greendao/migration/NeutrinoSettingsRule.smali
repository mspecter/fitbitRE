.class final Lcom/fitbit/data/repo/greendao/migration/NeutrinoSettingsRule;
.super Lcom/fitbit/data/repo/greendao/migration/MigrationRule;
.source "SourceFile"


# static fields
.field private static final NEUTRINO_SETTINGS_COLUMNS_SINCE_VERSION:I = 0x72

.field private static final TAG:Ljava/lang/String; = "NeutrinoSettingsRule"
...
.method protected executeRuleForDao(Landroid/database/sqlite/SQLiteDatabase;Lcom/fitbit/data/repo/greendao/migration/MigrationDaoResult;)Lcom/fitbit/data/repo/greendao/migration/MigrationResult;
    ...
    .line 38
    :cond_f
    sget-object v0, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao$Properties;->ScreenOrder:Lde/greenrobot/dao/Property;
    ...
    .line 39
    sget-object v1, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao$Properties;->ClockFaceImageUrl:Lde/greenrobot/dao/Property;
    ...
    .line 40
    sget-object v2, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao$Properties;->ClockFaceName:Lde/greenrobot/dao/Property;
    ...
    .line 41
    const-string v3, "TRACKER_SETTINGS"
    ...
    .line 47
    const-string v1, "NeutrinoSettingsRule"
    ...
    .line 48
    invoke-static {p1, v5}, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao;->dropTable(Landroid/database/sqlite/SQLiteDatabase;Z)V

    .line 49
    invoke-static {p1, v5}, Lcom/fitbit/data/repo/greendao/TrackerSettingsDao;->createTable(Landroid/database/sqlite/SQLiteDatabase;Z)V
