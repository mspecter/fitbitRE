.class public Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;
...
.method public constructor <init>()V
    ...
    .line 53
    new-instance v0, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment$1;

    invoke-direct {v0, p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment$1;-><init>(Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;)V

    iput-object v0, p0, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->b:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;

    .line 42
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->a(I)V

    .line 43
    return-void
.end method

.method static synthetic a(Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;)V
    .registers 1

    .prologue
    .line 39
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->o()V

    return-void
.end method

.method static synthetic b(Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;)Z
    .registers 2

    .prologue
    .line 39
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->m()Z
...
.method static synthetic c(Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;)V
    .registers 1

    .prologue
    .line 39
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->q()V
...
.method protected a(Lcom/fitbit/ui/FitbitChartView;)V
    ...
    .line 215
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 216
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->h()Lcom/fitbit/ui/FitbitChartView;
    ...
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->getResources()Landroid/content/res/Resources;
...
.method protected c()V
    ...
    invoke-virtual {p0, v0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->b(Z)V

    .line 234
    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->getLoaderManager()Landroid/support/v4/app/LoaderManager;

    move-result-object v0

    const/16 v1, 0xb6

    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->f()Ljava/util/Date;

    move-result-object v2

    invoke-virtual {p0}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->g()Ljava/util/Date;
    ...
    invoke-static {v2, v3, v4}, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->a(Ljava/util/Date;Ljava/util/Date;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object v2

    iget-object v3, p0, Lcom/fitbit/sleep/ui/TimesAwakenedChartFragment;->b:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
