.class public Lcom/fitbit/activity/ui/FloorsChartFragment;
...
.method public constructor <init>()V
    ...
    .line 61
    new-instance v0, Lcom/fitbit/activity/ui/FloorsChartFragment$1;

    invoke-direct {v0, p0}, Lcom/fitbit/activity/ui/FloorsChartFragment$1;-><init>(Lcom/fitbit/activity/ui/FloorsChartFragment;)V

    iput-object v0, p0, Lcom/fitbit/activity/ui/FloorsChartFragment;->l:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;

    return-void
.end method

.method static synthetic a(Lcom/fitbit/activity/ui/FloorsChartFragment;)V
    .registers 1

    .prologue
    .line 51
    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->o()V

    return-void
.end method

.method static synthetic b(Lcom/fitbit/activity/ui/FloorsChartFragment;)Z
    .registers 2

    .prologue
    .line 51
    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->m()Z
...
.method static synthetic c(Lcom/fitbit/activity/ui/FloorsChartFragment;)V
    .registers 1

    .prologue
    .line 51
    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->q()V
...
.method protected a(Lcom/fitbit/ui/FitbitChartView;)V
    ...
    .line 258
    iget-object v0, p0, Lcom/fitbit/activity/ui/FloorsChartFragment;->b:Lcom/fitbit/ui/j;

    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->getResources()Landroid/content/res/Resources;
    ...
    .line 259
    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->h()Lcom/fitbit/ui/FitbitChartView;
...
.method protected c()V
    ...
    invoke-virtual {p0, v0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->b(Z)V

    .line 266
    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->getLoaderManager()Landroid/support/v4/app/LoaderManager;

    move-result-object v0

    const/16 v1, 0x7b

    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->f()Ljava/util/Date;

    move-result-object v2

    invoke-virtual {p0}, Lcom/fitbit/activity/ui/FloorsChartFragment;->g()Ljava/util/Date;
    ...
    invoke-static {v2, v3, v4}, Lcom/fitbit/activity/ui/FloorsChartFragment;->a(Ljava/util/Date;Ljava/util/Date;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object v2

    iget-object v3, p0, Lcom/fitbit/activity/ui/FloorsChartFragment;->l:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
